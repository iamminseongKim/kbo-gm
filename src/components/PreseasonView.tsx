...
import { EnvironmentCard, EventOption } from '../types'
      ...
      <div className="apple-card rounded-3xl p-5 sm:p-6 space-y-4">
        <div className="flex items-center justify-between border-b border-black/[0.06] dark:border-white/[0.06] pb-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-neutral-600 dark:text-neutral-400">프리시즌 전력 보강</span>
          </div>
          <span className="text-xs text-neutral-500 dark:text-neutral-400 font-mono">{currentDecision.category}</span>
        </div>
